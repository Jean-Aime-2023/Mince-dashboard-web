...
const Notifications = ({openNotif}) => {
  return (
    <div className={` ${openNotif ? "flex": "hidden"}  flex-col justify-center items-center shadow-2xl`}>
        {/* <div><UpIcon/></div> */}
        <div className='bg-white py-5 px-6 rounded-xl max-w-[500px]'>
          <h2 className=' text-center mb-10 text-2xl font-bold'>Notifications</h2>
           ...
           <h1 className='mb-6 text-[#0A1027] text-[20px] font-semibold'>Today</h1>
           ...
           <h1 className='mb-6 text-[#0A1027] text-[20px] mt-10 font-semibold'>Yesterday</h1>
           ...
           <SingleNotification action="Go premium" iconBg="#EAEAEA" text="Upgrade to premium and unlock all features" bgNotif="#F0F0F0" border="#5547D7" />
           <h1 className='mb-6 text-[#0A1027] text-[20px] mt-10 font-semibold'>Last Month</h1>
